...
namespace com.Sconit.Persistence
{
	...
	/// </summary>
    public class SconitAdoTransaction : ITransaction
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(SconitAdoTransaction));
        ...
        public SconitAdoTransaction(ISessionImplementor session)
        {
