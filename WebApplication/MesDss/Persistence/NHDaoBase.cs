...
namespace com.Mes.Dss.Persistence
{
    /// <summary>
    ...
    public class NHDaoBase : INHDao
    {
        ...
        public string sessionFactoryAlias = "mes";
        ...
        /*
        public ISession GetSession(string sessionFactoryAlias)
        {
            if (sessionFactoryAlias == null || sessionFactoryAlias.Length == 0)
                return sessionManager.OpenSession();
            else
        ...
        public ISession GetOracleSession()
        {
            return this.GetSession("oracle");
        }*/
        #endregion
    }
}
