...
namespace com.Sconit.Service.Transportation
{
    public interface ITransportPriceListDetailMgr : ITransportPriceListDetailBaseMgr
    {
        ...
        TransportPriceListDetail GetLastestTransportPriceListDetail(TransportPriceList priceList, DateTime effectiveDate, Currency currency, string pricingMethod, TransportationAddress shipFrom, TransportationAddress shipTo, string priceListType, string vehicleType);
