...
namespace com.Sconit.Utility
{
	...
	{ 
		...
		public SocketFtpHelper(string server, string username, string password) 
		{ 
			this.server = server; 
		...
		public SocketFtpHelper(string server, string username, string password, int timeoutSeconds, int port) 
		{ 
			this.server = server; 
			this.username = username; 
			this.password = password; 
