    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            #region DetachedCriteria
                ...
                DetachedCriteria selectCriteria = DetachedCriteria.For(typeof(PurchasePlanMstr));
                DetachedCriteria selectCountCriteria = DetachedCriteria.For(typeof(PurchasePlanMstr))
