<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Preview.ascx.cs" Inherits="NewMrp_ShiftPlan_Preview" %>
<%@ Register Src="PreviewDetail.ascx" TagName="Detail" TagPrefix="uc2" %>
<%--<%@ Register Src="ExistsDetail.ascx" TagName="ExistsDetail" TagPrefix="uc2" %>--%>
...
<fieldset>
        ...
        <asp:GridView ID="GV_List" runat="server" AutoGenerateColumns="false" OnRowDataBound="GV_List_RowDataBound">
            <Columns>
              ...
              <%--  <asp:TemplateField HeaderText="${Common.Business.Description}">
                ...
                <%--<asp:TemplateField>
                    <ItemTemplate>
                        <uc2:ExistsDetail ID="ucExistsDetail" runat="server" />
                    </ItemTemplate>
                </asp:TemplateField>--%>
            </Columns>
        </asp:GridView>
    ...
    <div class="tablefooter buttons">
        <asp:Button ID="btnCreate" runat="server" Text="${Common.Button.Create}" OnClick="btnCreate_Click"
            CssClass="add" />
        <asp:Button ID="Button1" runat="server" Text="Back" OnClick="btnBack_Click" CssClass="back" />
