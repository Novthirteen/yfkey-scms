...
public partial class NewMrp_WeeklyPurchasePlan_Search : SearchModuleBase
{
    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            ...
            DetachedCriteria selectCriteria = DetachedCriteria.For(typeof(WeeklyPurchasePlanMstr));
            DetachedCriteria selectCountCriteria = DetachedCriteria.For(typeof(WeeklyPurchasePlanMstr))
