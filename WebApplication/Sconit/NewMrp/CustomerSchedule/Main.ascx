<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="NewMrp_CustomerSchedule_Main" %>
...
<div id="search" runat="server">
    ...
    <table class="mtable" runat="server" id="tblSearch">
        <tr>
            ...
            <td class="td02">
                <asp:TextBox ID="tbReferenceScheduleNo" runat="server" Width="165" />
            </td>
        </tr>
        <tr>
            <td class="td01">
            ...
            <td class="td02">
                <asp:TextBox ID="tbVersion" runat="server" Width="165" />
            </td>
        </tr>
        <tr>
            <td class="td01">
