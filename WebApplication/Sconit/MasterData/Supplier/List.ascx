    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="PaymentTerm" HeaderText="${MasterData.Supplier.PaymentTerm}" SortExpression="PaymentTerm" />
                <asp:BoundField DataField="TradeTerm" HeaderText="${MasterData.Supplier.TradeTerm}" SortExpression="TradeTerm" />
