            ...
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <uc3:textbox ID="tbTPriceList" runat="server" DescField="Code" ValueField="Code"  ServiceParameter="string:#tbCarrier"
                                Width="250" ServicePath="TransportPriceListMgr.service" ServiceMethod="GetTransportPriceList" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
