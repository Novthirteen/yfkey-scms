<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="MasterData_Reports_WorkshopFinshGoods_List" %>
    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.Business.HuId}" SortExpression="Hu.huId">
                    <ItemTemplate>
                        <asp:Label ID="lblBinCode" runat="server" Text='<%# Eval("Hu.huId")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
