<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TabNavigator.ascx.cs" Inherits="Procurement_RollingForecast_TabNavigator" %>
...
<div class="AjaxClass  ajax__tab_default">
    <div class="ajax__tab_header">
        ...
        class='ajax__tab_tab'><asp:LinkButton ID="lbManual" Text="${Common.Business.RollingForecast}" runat="server" OnClick="lbManual_Click" /></span></span></span></span><span 
