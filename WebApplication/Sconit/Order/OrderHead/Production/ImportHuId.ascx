<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ImportHuId.ascx.cs" Inherits="Order_OrderHead_Production_ImportHuId" %>
        ...
        <table style="width: 100%" class="mtable">
            ...
            <td class="td02">
                <asp:HyperLink ID="hlTemplate" runat="server" Text="${Common.Business.ClickToDownload}"
                    NavigateUrl="~/Reports/Templates/ImportTemplates/ImportProductionHuId.xls"></asp:HyperLink>
            </td>
        </tr>
         <tr>
            <td colspan="3" />
