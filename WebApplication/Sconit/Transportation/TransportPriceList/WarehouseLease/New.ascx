<%@ Control Language="C#" AutoEventWireup="true" CodeFile="New.ascx.cs" Inherits="Transportation_TransportPriceList_WarehouseLease_New" %>

<%@ Register Src="~/Controls/TextBox.ascx" TagName="textbox" TagPrefix="uc3" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>
<script language="javascript" type="text/javascript" src="Js/DatePicker/WdatePicker.js"></script>
<div id="floatdiv">
    <asp:FormView ID="FV_WarehouseLease" runat="server" DataSourceID="ODS_WarehouseLease" DefaultMode="Insert"
        DataKeyNames="Id">
        <InsertItemTemplate>
            <fieldset>
                <legend>${Transportation.TransportPriceListDetail.AddWarehouseLease}</legend>
                <table class="mtable">
                    <tr>
                        <td class="td01">
