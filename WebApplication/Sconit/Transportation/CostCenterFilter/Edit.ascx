<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Edit.ascx.cs" Inherits="CostCenterFilter_Edit" %>
    ...
    <asp:FormView ID="FV_TransportationBill" runat="server" DataSourceID="ODS_TransportationBill"
        ...
        <EditItemTemplate>
            <table class="mtable">
                ...
                <tr>
                <td  class="td01">供应商代码:</td> 
                 <td class="td02">
                        <sc1:ReadonlyTextBox ID="ReadonlyTextBox1" runat="server" CodeField="BillAddress.Party.Country"
                            DescField="BillAddress.Party.Country" />
                    </td>
...
<fieldset>
    <legend>成本分摊</legend>
    <div class="GridView">
        <table class="mtable" cellpadding="4"  cellspacing="0"  border="1" style="border-collapse:collapse;" >
        <tr style="line-height:150%;background-color:#606060;color:white;font-weight:bold;font-size:12px;text-align:center;">
        <td>成本中心</td><td>科目代码</td><td>不含税金额</td><td>税金</td>
        </tr>
            <%=CostString %>
            <tr>
            <td colspan="2" style=" text-align:right">合计:</td>
            <td style="text-align:center;"><%=OutTaxTotal %></td>
