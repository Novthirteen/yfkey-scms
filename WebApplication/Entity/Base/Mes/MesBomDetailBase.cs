...
{
    [Serializable]
    public abstract class MesBomDetailBase : EntityBase
    {
        ...
        private com.Sconit.Entity.Mes.MesBom _bom;
        public com.Sconit.Entity.Mes.MesBom Bom
		{
			get
			{
				return _bom;
        ...
        {
            MesBomDetailBase another = obj as MesBomDetailBase;
